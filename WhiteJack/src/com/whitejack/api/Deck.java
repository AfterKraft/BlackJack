...
public class Deck extends Card {
	...
	public Card dealCard() {
		...
		log.debug("[Deck] Check to make sure the Deck.dealcard has been started. in Deck"); // Debugging
																							// line

		Card temp = card[i];
		log.debug("[Deck] The temporary temp object of type Card has been created!"); // Debugging
																						// line
